...
function playerSummary(id, p) {
  return {
    ...
    x: p.x, y: p.y, z: p.z, yaw: p.yaw, alive: p.alive, ready: !!p.isReady
  };
}
    ...
    switch (msg.t) {
      case 'state': {
        ...
        broadcast(room, {
          ...
          charging: !!msg.charging, chargeReady: !!msg.chargeReady,
          shield: !!msg.shield, charId: msg.charId,
          ready: !!msg.ready, assault: !!msg.assault, unibeam: !!msg.unibeam,
          extraShield: msg.extraShield || 0,
          hovering: !!msg.hovering,
          cardCharging: !!msg.cardCharging, cardChargeTier: msg.cardChargeTier || 0,
          drone: msg.drone || null,
          illusions: msg.illusions || null,
          walls: msg.walls || null,
          aimLine: msg.aimLine || null,
          bazooka: !!msg.bazooka,
          jeff: msg.jeff || null,
          allyBuff: msg.allyBuff || null
        }, playerId);
        break;
      }
      case 'action': {
